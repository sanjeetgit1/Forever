...
<div className=" flex gap-3 flex-col lg:flex-row">
  ...
  <div  onClick={()=>setMethod('cod')}  className="flex items-center gap-3 border p-2 px-3 cursor-pointer">
    ...
    <p className="text-gray-100 text-sm font-medium mx-4">CASH ON DELIVERY</p>

  </div>

</div>
<div className="w-full text-end mt-8">
  <button onClick={()=>navigate('/orders')} className=" bg-white   rounded text-black font-bold px-16 py-3 text-sm">PLACE ORDER</button>
